...
public interface SysUserMapper extends ISqlMapper {
    ...
    List<SysUser> getBusinessAll();

    void insertAllotChannel(BusinessChannel businessChannel);

    Integer selectBusinessChannelCount(@Param("userId") Integer userId);

    void updateAllotChannel(BusinessChannel businessChannel);

    String selectBusinessChannelByUserId(@Param("userId") Integer userId);
}
