 ...
 */
@Controller
@RequestMapping("/pc/channelshare")
public class PcChannelShareController {
    private static final Logger LOGGER = Logger.getLogger(PcChannelShareController.class);
    @Autowired
    ...
    public String getProductVersions(Model mode, HttpServletRequest request){
        ...
        String scaleType=request.getParameter("scaleType")==null?"pc":request.getParameter("scaleType");//分成类型
        Page page=new Page();
    ...
    public String toAddChannelDataScale(HttpServletRequest request){
        ...
        return "pc/channelshare/addchannelsharescale";
    }
    ...
    public String addChannelDataScale(HttpServletRequest request, ChannelDataScale channelDateScale){
      try {
         ...
         // LoginUser user = (LoginUser) request.getSession().getAttribute(WebConstants.SESSION_USER);
          ...
          for(int i=0;i<cnids.length;i++) {
              ...
              if(ExchannelDataScale!=null){
               //已经存在分成比例了
                  return "redirect:/pc/channelshare/toAddChannelDataScale?scaleType="+channelDateScale.getScaleType()+"&type=1&cnid="+cnids[i]+"";
              }
          }
          for(int i=0;i<cnids.length;i++) {
              channelDateScale.setCnid(cnids[i]);
        ...
        return "redirect:/pc/channelshare/getchannelsharelist?scaleType="+channelDateScale.getScaleType()+"";
    }
    ...
    public String toUpdatechanneldata(HttpServletRequest request, Integer id){
        ...
        return "pc/channelshare/toupdatechanneldata";
    }
    /**
     * 修改渠道分成
     * @param request
    ...
    public String updateChannelDataScale(HttpServletRequest request, ChannelDataScale channelDateScale){
        ...
        return "redirect:/pc/channelshare/getchannelsharelist";
    }
